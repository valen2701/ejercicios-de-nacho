...
def send_message():
    print(f"Estoy invitando a {len(lista_de_personas)} personas a cenar.")
    ...
    print(f"Ahora quedan {len(lista_de_personas)} invitados.")
...
def new_people():
    ...
    print(lista_de_personas)
    print(f"Ahora estoy invitando a {len(lista_de_personas)} personas.")
...
def cancel_party():
    ...
    print(lista_de_personas)
    print(f"Al final quedan {len(lista_de_personas)} invitados.")
